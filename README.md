...
const jayModi = {
  ...
  technologies: {
    languages: ["TypeScript", "JavaScript (ES6+)", "Python", "SQL", "PHP/Laravel", "Motoko"],
    frontend: ["React", "Vite", "Redux", "Next.js", "Bootstrap", "Tailwind CSS", "jQuery"],
    backend: ["Node.js", "Express.js", "PHP", "RESTful/SOAP APIs", "GraphQL", "JWT", "OAuth2"],
    database: ["PostgreSQL", "MySQL", "MongoDB"],
    devOps: ["Docker", "GitHub Actions", "Nginx", "CI/CD", "Husky", "ESLint"],
    cloud: ["AWS (EC2)", "Vercel", "Heroku", "Render", "GitHub Pages", "Certbot"],
    web3: ["Internet Computer blockchain", "ICP", "DFX", "Canisters", "NFTs", "Tokens"],
    crmCms: ["SmartSimple", "MS Dynamics 365", "WordPress"],
...
AI-powered resume builder with modern authentication and containerized cloud deployment.

### 🍽️ [Dine-and-Play](https://github.com/thisisjaymodi/dine-and-play)
**React 19 | Vite | Tailwind CSS | DaisyUI**
Modern restaurant management and gaming frontend application.

### 🏦 [DBank](https://github.com/thisisjaymodi/dbank)
**Internet Computer | Motoko | DFX | React**
Decentralized banking application on the IC blockchain.
